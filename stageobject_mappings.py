...
Bedroom = Stage('Bedroom', {1: 'The room is extremely cozy and great for cuddling! It smells of freshly baked chocolate chip cookies and makes you feel warm and fuzzy inside. You are even more excited for what\'s to come tonight.', 2: 'Wow this room is a mess! Are those dirty socks? Is that a beer bottle on the dresser? Yikes! It looks like a hurrican came through here. You better clean up if you want to impress that Special Someone.',3: 'Wow this room is a mess! Are those dirty socks? Is that a beer bottle on the dresser? Yikes! It looks like a hurrican came through here. You better clean up if you want to impress that Special Someone.'} ,'bedroom.png',
...
Approach2 = Stage('Approach2',{0: 'She screams, "GET...OUT...OF...MY HOUSE!!!" You are very confused at this point. You say, "But, it\'s just me, Your Beloved"'},'bedroom.png',
...
[MappingObject(Bedroom, 'Go upstairs to the bedroom!', [1,2,3]),
    MappingObject(Kitchen, 'Go downstairs to the kitchen!', [1,2]),
...
Intro2 = Stage('Intro2', {0 : '"Goodmorning Julia, it\'s mom! Are you still in bed, you sleepy head? You missed our family brunch. Anyways, love you sweetheart. Call me soon, I miss you and a mother deserves at least a weekly phone call from her only daughter"'}, 'livingroom.png', [MappingObject(Intro3, 'Aww so cute', [0])])
