...
Daisy = Stage('daisies', {0: 'The daisies can put up little resistance to your giant hedge clippers. On your way back to the house a neighbor gives you a funny look, but you just stick your toungue out at him'},'garden.jpeg', None, 2)
...
Trash = Stage('Trash', {0: 'You want to empty out the trash tonight, so everything is absolutely perfect! However, when you look into the trash can, you notice bouquets of flower in the trash. These don\'t belong in the trash, they are good as new! Suddenly, you think you hear a noise from upstairs... Eh it\'s probably nothing'},'kitchen.png')
...
Weapon = Stage('Weapon', {0: 'You shove a newly polished fork in your pocket. Might be useful later. Are the noises upstairs getting louder?'},'kitchen.png',None,7)
...
Notes = Stage('Notes', {0: 'There are notes! They are percariously stacked up on the nightstand and are spilling over onto the floor. Which note do you want to read?'},'bedroom.png',
...
Bedroom = Stage('Bedroom', {0: 'Wow this room is a mess! Are those dirty socks? Is that a beer bottle on the dresser? Yikes! It looks like a hurrican came through here. You better clean up if you want to impress that Special Someone.'} ,'bedroom.png',
...
Bottle = Stage('Bottle',{0: 'You jump up and grab the bottle first. While you are distracted Julia grabs a lamp and swings it over her head. She brings it down over your head and everything goes dark'},'Black.jpg',
...
Approach3 = Stage('Approach3',{0: 'You say, "But Julia, I am still not done preparing for our perfect date, and you didn\'t even put on the OUTFIT I put out for you. If you don\'t calm down, I will have to tie you and put you back into the closet." She says, "I\'LL CALL THE POLICE!"'},'Dark.jpeg',
...
Approach = Stage('Approach',{0: 'She says "Stay away from me! First the flower, then the letters, now this!? You need to leave. Now!". She does not know whats happening. She needs to be calmed down'},'bedroom.png',
