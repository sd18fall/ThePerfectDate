...
Pizza = Stage('pizza!', {0: 'Oof, there may or may not be some tomato sauce in your hair. You had better go clean up, but it is going to be totally worth it when the Platonic Pizza is done!'},'kitchen.png',None, 2)
...
Rose = Stage('roses', {0: 'You prick your fingers trying to pick the rose, but no flower can defeat you! On your way back to the house a neighbor gives you a funny look, but you just stick your toungue out at him'},'garden.jpeg',None, 2)

Daisy = Stage('daisies', {0: 'A daisy can put up little resistance to your giant hedge clippers. On your way back to the house a neighbor gives you a funny look, but you just stick your toungue out at him'},'garden.jpeg', None, 2)

Sunflower= Stage('sunflowers', {0: 'Nothing says, "I like you" like a flower as big as your face. The sunflower you picked is a giant monster flower and you are proud of yourself. On your way back to the house a neighbor gives you a funny look, but you just stick your toungue out at him'},'garden.jpeg', None, 2)

Garden = Stage('FLOWER', {0: 'There is a beautiful flower garden in the backyard. You are obsessed with the way flowers look and love this garden, but you have never had much luck as a gardener. Which flower are you going to chose to use tonight? '},'garden.jpeg',
...
Trash = Stage('Trash', {0: 'You want to empty out the trash tonight, so everything is absolutely perfect! However, when you look into the trash can, you notice bouquets of FLOWERs in the trash. These don\'t belong in the trash, they are good as new! Suddenly, you think you hear a noise from upstairs... Eh it\'s probably nothing'},'kitchen.png')

Kitchen = Stage('Kitchen', {0: 'Nothing screams cozy and comfy like a home cooked meal! You have been learning how to cook since you were a child and are super eager to wow your date with your deliciously hypnotizing dishes!'},'kitchen.png',
[MappingObject(Cookbook, 'Check out your favorite cookbook for a recipe to cook for tonight!', [0]),
    MappingObject(Garden, 'Head to your garden to choose a flower for tonight!', [0]),
...
Dreams= Stage('Dreams', {0: '"Dear Diary, I keep having the same dream over and over agian. I am sitting in my kitchen and I am having THE most amazing date with THE most handsome man... I sure hope that it\'s foreshadowing! -Love Julia"'},'bedroom.png')
...
Bedroom = Stage('Bedroom', {0: 'Wow this room is a mess! Look at those empty beer bottles all over the nightstand! You better clean up if you want to impress that Special Someone. Yes you are definitly going to clean. As soon as you are done picking out a dress. Oh who are you kidding?'} ,'bedroom.png',
...
TheEnd = Stage('TheEnd',{0: 'The End'},'bedroom.png')
...
Pulled = Stage('Pulled',{0: 'You pull Julia onto the ground. Hard. There is a loud cracking noise and her arms go limp.'},'bedroom.png',
[MappingObject(TryAgain,'Try again',[0]),
MappingObject(NotOver,'This isn\'t over',[0])])

Bottle = Stage('Bottle',{0: 'You jump up and grab the bottle first. While you are distracted Julia grabs a lamp and swings it over her head. She brings it down over your head and everything goes dark'},'bedroom.png',
[MappingObject(TheEnd,'The End',[0])])

Approach8 = Stage('Approach8',{0: 'You touch the back of your head and your fingers are red with blood. Everything is in slow motion. Julia lunges for the beer bottle'},'bedroom.png',
[MappingObject(Pulled,'Pull her down',[0]),
MappingObject(Bottle,'Get the bottle first',[0])])

Approach7 = Stage('Approach7',{0: 'You try to push Julia away but she trips you. You are trying to explain to her, you love her, you only want what is best for her, as she kicks you in the head'},'bedroom.png',
[MappingObject(Approach8,'Check on your head',[0])])

Approach6 = Stage('Approach6',{0: 'You scream and pull Julia towards you. She rams into you and grabs you by the arms. She is reaching for an empty beer bottle on the nightstand. You try to turn her around and push her against the wall.'},'bedroom.png',
...
Approach3 = Stage('Approach3',{0: 'You say, "But Julia, I am still not done preparing for our perfect date, and you didn\'t even put on the OUTFIT I put out for you. If you don\'t calm down, I will have to tie you and put you back into the closet." She says, "YOU CRAZY PSYCHO. I\'LL CALL THE POLICE!"'},'bedroom.png',
...
Approach = Stage('Approach',{0: 'She says "Stay away from me! First the FLOWERs, then the letters, now this!? You need to leave. Now!". She does not know whats happening. She needs to be calmed down'},'bedroom.png',
...
Intro3 = Stage('Intro3', {0 : 'She comes every monday to drop off groceries, but she never stays long. Anyways time to get ready! Tonight is a big night!'},'livingroom.png',
[MappingObject(Hallway, 'Start the preparations!', [0])])

Intro2 = Stage('Intro2', {0 : '"Goodmorning Julia, it\'s mom! Are you still in bed, you sleepy head. I brought you some groceries to start your week! Anyways, love you sweetheart. Call me soon, I miss you and a mother deserves at least a weekly phone call from her only daughter"'},'livingroom.png', [MappingObject(Intro3, 'Aww so cute', [0])])

Intro = Stage('Intro', {0 : 'You finish washing your hands and shoot yourself a smile in the mirror. You wink once at your reflection and admire how nice you look today! Your blue eyes are especially vibrant. You hear a voice from downstairs'},'livingroom.png', [MappingObject(Intro2, '"Hm I bet I know who that is!"', [0])])
