...
Lasagna = Stage('Lasagna', {0: 'Making the Lovers Lasagna takes a biiit longer than you expected, but once it is in the oven the room immediatly smells delicious'},'kitchen.png', None, None, 2)

Pizza = Stage('Pizza', {0: 'Oof, there may or may not be some tomato sauce in your hair. You had better go clean up, but it is going to be totally worth it when the Platonic Pizza is done it will be totally worth it!'},'kitchen.png', None, None, 2)

Salad = Stage('Salad', {0: 'Well you made a salad. Even with a cool name like Sweetheart Cesear Salad it is still just a salad, so congrats I guess?'},'kitchen.png' None, None, 2)
...
Rose = Stage('Rose', {0: 'You prick your fingers trying to pick the Rose, but no flower can defeat you!'},'garden.jpeg', None, None, 2)

Daisy = Stage('Daisy', {0: 'A Daisy can put up little resistance to your giant hedge clippers.'},'garden.jpeg', None, None, 2)

Sunflower= Stage('Sunflower', {0: 'Nothing says, "I like you" like a flower as big as your face. The Sunflower you picked is a giant monster flower and you are proud of yourself'},'garden.jpeg', None, None, 2)
...
SunDress= Stage('SunDress', {0: 'What a cute Sun Dress! Yellow with pink flowers, this warm summery look will light up any room!'},'bedroom.png',None, None, 2)

TShirt= Stage('TShirt', {0: 'T Shirt and Jeans is just a classic Julia outfit, and why mess with a classic??'},'bedroom.png',None, None, 2)

PowerSuit= Stage('PowerSuit', {0: 'Go big or go home. Nothing screams confidence like a bright red suit. And the best part is it basically matches everything!'},'bedroom.png',None, None, 2)
...
Stranger= Stage('Stranger', {0: '"I saw a very Handsome Stranger the other day in the park today! He was staring right at me and his blue eyes reminded me of Steven. I sure hope Steven calls soon..."'},'bedroom.png',None, None, 2)

Dreams= Stage('Dreams', {0: '"I keep having the same dream over and over agian. I am sitting in my kitchen and I am having THE most amazing date with THE most handsome man. He has beautiful blue eyes... I sure hope that its foreshadowing!"'},'bedroom.png',None, None, 2)

LoveLife= Stage('LoveLife', {0: '"I cannot stop thinking about Steven! When we talked on the phone last week I had butterflies for hours! I sure hope he asks me on a date soon..."'},'bedroom.png',None, None, 2)
...
Stranger.backbuttonmapping = Dairy
Dreams.backbuttonmapping = Diary
LoveLife.backbuttonmapping = Diary
...
def backButtonGen (stage):
    backButton = MappingObject(goBack(stage),'Back',[0])
    stage.buttonMapping += backButton

stageList = [Cookbook,Garden,Lasagna,Salad,Pizza,Rose,Daisy,Sunflower,Trash,Kitchen,OOutfitMakeup,Diary,Sundress,TShirt,PowerSuit,Stranger,Dreams,LoveLife,Notes,Bedroom]
